...
const day1Main: ProgramListBlock[] = [
  ...
  },
  {
    ...
    entry: {
      time: "10:50 - 11:05",
      type: "виступ",
      speakers: [{ name: "Тетяна Духова", description: "CEO Ecotech Invest" }],
    },
  },
  {
    kind: "entry",
...
const day2Vyzhnytsia: ProgramListBlock[] = [
  ...
  { kind: "bar", label: "ПЕРША ЧАСТИНА", tone: "accent" },
  {
    ...
    entry: {
      ...
      bullets: ["Зустріч на центральній площі міста. Емоційний старт та занурення у творчий потенціал регіону"],
    },
  },
  {
    kind: "entry",
    entry: {
      time: "12:20 - 12:55",
      title: "Урочисте відкриття муралу, присвяченого 55-річчю переможного виступу пісні «Червона рута»",
      bullets: ["Виступ фольклорного театру-студії «Ґердан»"],
    },
  },
  {
    kind: "entry",
  ...
  { kind: "bar", label: "Виїзд до урочища Гамованка (р. Черемош)", tone: "dark", time: "13:30 - 13:40" },
  { kind: "entry", entry: { time: "13:40 - 13:55", title: "Знайомство з інвестиційними проєктами Вижниці" } },
  {
    kind: "entry",
    entry: {
      time: "14:00 - 15:30",
  ...
  },
  {
    ...
    entry: {
      time: "15:30 - 16:30",
      title: "Від першої інвестиції до великого бізнесу",
      speakers: [
        {
          name: "Ростислав Вовк",
  ...
  { kind: "bar", label: "Виїзд до скелі Соколине Око", tone: "dark", time: "16:30 - 17:30" },
  {
    kind: "entry",
    entry: {
      time: "17:30 - 20:30",
      title: "Урочище Лужки. Афтепаті біля вогнища",
      bullets: [
        "Гастрономія у форматі «Буковинське частування»",
        "Кулуарний нетворкінг",
        "Майстер-клас гри на трембіті",
        "Виступ фіналістів «Україна має таланти» — гурту «ЗАПАЛ»",
        "Запальні «Троїсті музики»",
      ],
    },
  },
  { kind: "bar", label: "Виїзд до Чернівців", tone: "dark", time: "20:30 - 21:30", marginBottom: 40 },
];
