  ...
  tickets: [
    {
      ...
      cta,
      features: [
        { text: "Доступ до Expo Zone з найкращими брендами та партнерами ззовні театру" },
        { text: "Можливість наживо поспілкуватися з представниками компаній" },
        {
          text: "Ідеальний варіант для тих, хто хоче налагодити корисні зв'язки або знайти нових партнерів та бути частиною події",
          strong: true,
        },
      ],
    },
    {
      ...
      cta,
      features: [
        { text: "Все, що входить у Expo, а також:", strong: true },
