...
import {
  PHONE_MAX_USER_DIGITS,
  formatPhoneFromUserDigits,
  getPhoneUserDigits,
} from "./phoneMask";

/** the mask is caret-hostile: editing mid-string would reshuffle the separators, so the caret is pinned to the end */
